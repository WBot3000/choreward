...
import { createRewardItems } from "../graphql/mutations";
export default function RewardItemsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createRewardItems.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "RewardItemsCreateForm")}
      {...rest}
    >
      <TextField
        label="Reward name"
