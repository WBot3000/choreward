...
import { createChanllenges } from "../graphql/mutations";
export default function ChanllengesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createChanllenges.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ChanllengesCreateForm")}
      {...rest}
    >
      <TextField
