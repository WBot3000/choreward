...
import useFetchFamilies from './hooks/useFetchFamily'; //importing the fetch family hoot
...
function NotFamily() {
    ...
    const handleFormSubmit = async (event) => {
        ...
        const newFamilyData = {
            name: formData.get('family_name'), // Assuming 'family_name' is the input field ID. Need to change this after checking
...
const CreateForm = ({onSubmit}) => {
    return <form className='flex justify-center items-center'onSubmit={onSubmit}>
