...
function RewardsDisplay({familyId, isHead}) {
  ...
  return (
    <div>
      ...
      <button type="button" className="ml-10 mt-10 mb-2 text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-10 py-5 text-center me-2">Earned Points {parseInt(EarnedPoints)}</button>
      <div className="flex">
...
<div className = "pb-10">
 ...
 <a href="#" className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
     <div className="flex flex-col justify-between p-4 leading-normal">
        ...
        <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" onClick={() => handleRedeem(item.points)}>Redeem</button>
     </div>
    </a>
    </div>
  </article>
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <form className="space-y-4 mt-5" action="#">
                    <div>
                        <label htmlFor="RewardName" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Reward Name</label>
                        <input value={newReward.RewardName} onChange={handleInputChange} type="text" name="RewardName" id="name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Xbox" required />
                    </div>
                    <div>
                        <label htmlFor="RewardCost" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Reward Cost</label>
                        <input value={newReward.RewardCost} onChange={handleInputChange} type="text" name="RewardCost" id="cost" placeholder="2500" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required />
                    </div>
                    </form>
